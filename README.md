...
# pyBAR [![Code Status](https://landscape.io/github/SiLab-Bonn/pyBAR/v2.1.x/landscape.svg?style=flat)](https://landscape.io/github/SiLab-Bonn/pyBAR/v2.1.x) [![Build Status](https://travis-ci.org/SiLab-Bonn/pyBAR.svg?branch=v2.1.x)](https://travis-ci.org/SiLab-Bonn/pyBAR/branches) [![Build Status](https://ci.appveyor.com/api/projects/status/github/SiLab-Bonn/pyBAR?branch=v2.1.x&svg=true)](https://ci.appveyor.com/project/DavidLP/pybar-71xwl?branch=v2.1.x)
