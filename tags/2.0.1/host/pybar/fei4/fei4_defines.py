...
fei4a = {
    ...
    'global_registers': {
        ...
        'TdacVbp': {'value': 160, 'address': 7, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        ...
        'FdacVbn': {'value': 20, 'address': 10, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        ...
        'PrmpVbpf': {'value': 100, 'address': 12, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        ...
        'EN_40M': {'value': 1, 'address': 28, 'bitlength': 1, 'offset': 9, 'description': ''},
...
d.update({
    ...
    'global_registers': {
        ...
        'GADCVref': {'value': 170, 'address': 5, 'bitlength': 8, 'littleendian': True, 'description': 'also BufVgOpAmp'},
        'PrmpVbp_R': {'value': 43, 'address': 5, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        'PrmpVbp': {'value': 43, 'address': 6, 'bitlength': 8, 'littleendian': True, 'description': ''},
        'spare_6': {'value': 0, 'address': 6, 'bitlength': 8, 'offset': 8, 'readonly': True, 'description': ''},
        'DisVbn': {'value': 26, 'address': 7, 'bitlength': 8, 'littleendian': True, 'description': ''},
        'TdacVbp': {'value': 80, 'address': 7, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        'Amp2VbpFol': {'value': 26, 'address': 8, 'bitlength': 8, 'littleendian': True, 'description': ''},
        'Amp2Vbn': {'value': 79, 'address': 8, 'bitlength': 8, 'littleendian': True, 'offset': 8, 'description': ''},
        'Amp2Vbp': {'value': 85, 'address': 9, 'bitlength': 8, 'littleendian': True, 'description': ''},
