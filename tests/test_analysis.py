...
class TestAnalysis(unittest.TestCase):
    ...
    def test_data_aligned_at_events(self):
        with tb.open_file(tests_data_folder + 'unit_test_data_2_hits.h5', 'r') as h5_file:
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=1000000)
            event_numbers = []
            for arr, _ in gen:
...
#             self.assertSequenceEqual(event_numbers, h5_file.root.Hits[:]["event_number"].tolist())
            ...
            # test chunk size
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=224)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
...
#             self.assertEqual(613, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=223)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)

            # test stop event number
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=0, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=110200, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            ...
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=224)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)

            # test start event number
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
#             self.assertEqual(224, arr.shape[0])
#             self.assertEqual(448, index)
...
#             self.assertEqual(165, arr.shape[0])
#             self.assertEqual(613, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            arr, index = gen.next()
            self.assertEqual(165, arr.shape[0])
            self.assertEqual(613, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
...
#             self.assertEqual(19997, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
...
#             self.assertEqual(19997, index)
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=0, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=2, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=3800, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=3800, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=3801, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
#             self.assertEqual(224, arr.shape[0])
#             self.assertEqual(448, index)
#             self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=110200, start_index=None, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
#             self.assertEqual(9774, arr.shape[0])
#             self.assertEqual(9998, index)
...
#             self.assertRaises(StopIteration, gen.next)
            ...
            # test stop index
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(499, arr.shape[0])
            self.assertEqual(499, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=14784, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            arr, index = gen.next()
            ...
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=None, stop_index=14785, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            arr, index = gen.next()
            ...
            self.assertEqual(14784, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=110199, start_index=None, stop_index=14785, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            arr, index = gen.next()
            ...
            self.assertEqual(14782, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=110199, start_index=None, stop_index=14784, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            arr, index = gen.next()
            ...
            # test start index
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=0, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=500, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9999, arr.shape[0])
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(10222, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3801, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
#             self.assertEqual(9774, arr.shape[0])
#             self.assertEqual(10222, index)
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=0, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            test_gen(gen, start=0, size=10000, iterations=3)
#             arr, index = gen.next()
#             self.assertEqual(9998, arr.shape[0])  # assuming start index 0 is always aligned
#             self.assertEqual(9998, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=500, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
...
#             self.assertEqual(9996, arr.shape[0])
#             self.assertEqual(20495, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
...
#             self.assertEqual(9995, arr.shape[0])
#             self.assertEqual(20217, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3801, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
#             arr, index = gen.next()
#             self.assertEqual(9774, arr.shape[0])
#             self.assertEqual(10222, index)
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=None, start_index=0, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()  # assuming start index 0 is always aligned
            self.assertEqual(9998, arr.shape[0])
            self.assertEqual(9998, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=2, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            arr, index = gen.next()
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=224, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=200, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            arr, index = gen.next()
            self.assertEqual(165, arr.shape[0])
            self.assertEqual(613, index)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=200, stop_index=None, first_event_aligned=True, try_speedup=False, chunk_size=225)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            arr, index = gen.next()
            ...
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=0, start_index=None, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=0, start_index=None, stop_index=224, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=0, start_index=None, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=224, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=None, stop_event_number=3800, start_index=None, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            self.assertRaises(StopIteration, gen.next)
            ...
            # bad input
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=0, start_index=0, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=0, start_index=100, stop_index=0, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            # others
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=0, start_index=0, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=0, start_index=0, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=3800, start_index=0, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=0, stop_event_number=3800, start_index=0, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(224, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=3800, start_index=0, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=3800, start_index=0, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=3801, start_index=0, stop_index=100, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=3801, start_index=0, stop_index=500, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            arr, index = gen.next()
            self.assertEqual(224, arr.shape[0])
            self.assertEqual(448, index)
            self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3801, stop_event_number=110200, start_index=100, stop_index=15000, first_event_aligned=True, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=110200, start_index=100, stop_index=15000, first_event_aligned=True, try_speedup=False, chunk_size=10000)
...
#             self.assertEqual(14784, index)
#             self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=110200, start_index=100, stop_index=15000, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            test_gen(gen, start=224, stop=14784, size=10000)
#             arr, index = gen.next()
#             self.assertEqual(9875, arr.shape[0])
#             self.assertEqual(10099, index)
...
#             self.assertEqual(14784, index)
#             self.assertRaises(StopIteration, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=110200, start_index=224, stop_index=15000, first_event_aligned=False, try_speedup=False, chunk_size=10000)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=110200, start_index=100, stop_index=14784, first_event_aligned=True, try_speedup=False, chunk_size=10000)
...
#             self.assertRaises(StopIteration, gen.next)
            # chunk size
            gen = analysis_utils.data_aligned_at_events(h5_file.root.Hits, start_event_number=3800, stop_event_number=None, start_index=100, stop_index=None, first_event_aligned=False, try_speedup=False, chunk_size=224)
            self.assertRaises(analysis_utils.InvalidInputError, gen.next)
