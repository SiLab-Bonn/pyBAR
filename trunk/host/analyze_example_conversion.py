...
# scan_name = 'BOARD_ID_132_SCC_29_DUT_0_3.4_GeV_LOW_THR_SCAN_Vthin_AltFine_110_1'
# 
# chip_flavor = 'fei4a'
# input_file = 'data/' + scan_name + ".h5"
# output_file_hits = 'data/' + scan_name + "interpreted.h5"
# output_file_hits_analyzed = 'data/' + scan_name + "_analyzed.h5"
# scan_data_filename = 'data/' + scan_name


scan_name = 'SCC45_raw_data_cut_0'
 
chip_flavor = 'fei4a'
input_file = 'data/' + scan_name + ".h5"
output_file_hits = 'data/' + scan_name + ".h5"
output_file_hits_analyzed = 'data/' + scan_name + "_analyzed.h5"
scan_data_filename = 'data/' + scan_name
