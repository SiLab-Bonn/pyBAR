...
class FdacTuning(Fei4RunBase):
    ...
    def analyze(self):
        ...
        plotThreeWay(hist=self.tot_mean_best.transpose(), title="Mean ToT after FDAC tuning", x_axis_title="ToT mean", filename=self.plots_filename, minimum=0, maximum=15)
