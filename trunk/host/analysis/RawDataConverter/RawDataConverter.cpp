...
// The main is defined here, this is the testing program for the converter
#include <iostream>
#include <string>
#include <stdexcept>
#include <new>
...
#include "Converter.h"//the converter
...
int main(int argc, char* argv[])
{
   ...
   {
      std::cout<<"EXCEPTION File I/O error: "<<error.getCDetailMsg()<<" in "<<error.getCFuncName()<<"\n";
      //error.printError();
      system("pause");
      return -1;
   }
   ...
   {
      std::cout<<"EXCEPTION Data set I/O error: "<<error.getCDetailMsg()<<" in "<<error.getCFuncName()<<"\n";
      //error.printError();
      system("pause");
      return -1;
   }
   ...
   {
      std::cout<<"EXCEPTION Data space I/O error: "<<error.getCDetailMsg()<<" in "<<error.getCFuncName()<<"\n";
      //error.printError();
      system("pause");
      return -1;
   }
   ...
   {
      std::cout<<"EXCEPTION Data type I/O error: "<<error.getCDetailMsg()<<" in "<<error.getCFuncName()<<"\n";
      //error.printError();
      system("pause");
      return -1;
   }
   ...
   {
      std::cout<<"EXCEPTION Property list error: "<<error.getCDetailMsg()<<" in "<<error.getCFuncName()<<"\n";
      //error.printError();
      system("pause");
      return -1;
   }
