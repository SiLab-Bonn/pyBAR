...
class ExtTriggerScan(ScanBase):
    ...
    def scan(self, mode=0, trigger_latency=232, trigger_delay=14, col_span=[1, 80], row_span=[1, 336], timeout_no_data=10, scan_timeout=10 * 60, max_triggers=10000, enable_hitbus=False):
        '''Scan loop
