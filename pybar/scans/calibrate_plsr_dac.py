...
class PlsrDacScan(Fei4RunBase):
    _default_run_conf = {
        "colpr_address": range(25, 39),  # the double column range to measure the PlsrDAC output voltage for
    ...
    def scan(self):
        description = [('column_address', np.uint32), (self.scan_parameter, np.int32), ('voltage', np.float)]
