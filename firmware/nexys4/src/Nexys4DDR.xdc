...
set_false_path -from [get_clocks CLKOUT1] -to [get_clocks {CLKOUT2 CLKOUT3 CLKOUT5}]
set_false_path -from [get_clocks {CLKOUT2 CLKOUT5 CLKOUT3}] -to [get_clocks CLKOUT1]
...
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { TDC_IN }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { TDC_TRIG }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { TLU_RST }]; #IO_L23N_T3_35 Sch=jc[1]
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { TLU_TRG }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { TLU_BSY }]; #IO_L6P_T0_35 Sch=jc[7]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { TLU_CLK }]; #IO_L22P_T3_35 Sch=jc[8]

set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { DOBOUT[2] }]; #IO_L22N_T3_35 Sch=jc[3]
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { DOBOUT[3] }]; #IO_L21P_T3_DQS_35 Sch=jc[9]
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L15N_T2_DQS_35 Sch=jd[9]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { CMD_DATA }]; #IO_L20N_T3_35 Sch=jd[4]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { CMD_CLK }]; #IO_L13N_T2_MRCC_35 Sch=jd[10]
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { DOBOUT[0] }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { DOBOUT[1] }]; #IO_L15P_T2_DQS_35 Sch=jd[7]
