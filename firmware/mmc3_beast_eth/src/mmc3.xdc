...
set_property PACKAGE_PIN F8 [get_ports DOBOUT_N]
set_property IOSTANDARD LVDS_25 [get_ports DOBOUT*]
...
#####
set_property PACKAGE_PIN J11 [get_ports {M26_DATA1_P[0]}]
set_property PACKAGE_PIN J10 [get_ports {M26_DATA1_N[0]}]
