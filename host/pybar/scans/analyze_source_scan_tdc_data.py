...
analysis_configuration = {
    'scan_name': ['D:\\data\\FE-I4\\SinglePixelCharge\\ana\\28_scc_30_ext_trigger_scan'],  # the base file name(s) of the raw data file, no file suffix needed
    ...
    'event_status_select_mask': 0b0000010111011111,  # the event status bits to cut on
    ...
    "analysis_steps": [1],  # the analysis includes this selected steps. See explanation above.
...
def analyze_raw_data(input_files, output_file_hits, pdf_filename):
...
if __name__ == "__main__":
    ...
    if 1 in analysis_configuration['analysis_steps']:
        analyze_raw_data(input_files=raw_data_files, output_file_hits=hit_file, pdf_filename=analysis_configuration['scan_name'][0])
