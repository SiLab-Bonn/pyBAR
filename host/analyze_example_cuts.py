...
def select_hits(cluster_size_condition='cluster_size==1', n_cluster_condition='n_cluster==1'):
...
if __name__ == "__main__":
    ...
    select_hits(cluster_size_condition='cluster_size>=1', n_cluster_condition='n_cluster>=1')
